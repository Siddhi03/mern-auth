        ...
        <div className="p-3 max-w-lg mx-auto">
            ...
            <form className="flex flex-col gap-4">
                ...
                <p className="text-sm self-center">
                    ...
                    ):(imagePercent>0 && imagePercent<100 ? <span className="text-slate-700">{`Uploading: ${imagePercent} %`}</span> : imagePercent ===100? (<span className="text-green-700">Image Uploaded Successfully</span>):'')}
                </p>
                ...
                <input defaultValue={currentUser.email} type="email" id="email" placeholder="Email" className="bg-slate-100 rounded-lg p-3"></input>
